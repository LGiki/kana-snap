...
export function KanaCard({
	...
	return (
		<button
			...
			className={cn(
				"flex flex-col items-center justify-center p-2 sm:p-3 rounded-xl border border-border bg-surface hover:bg-primary-50 hover:border-primary-400 dark:hover:border-primary-600 dark:hover:bg-primary-900/60 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200 cursor-pointer active:scale-95 active:translate-y-0 active:shadow-none min-w-0",
				className,
			)}
		>
			...
			<span className="kana-chart__romaji text-[10px] sm:text-xs text-text-muted mt-1">
				{kana.romaji}
			</span>
		</button>
	);
